...
Deliberately NOT here, so nobody re-derives the search:
  ...
  * Any hunting of the 2026-08-01 crash itself.  It is unreproducible with
    nothing to bisect from; a hypothesis-driven rebuild of the 2DH path would
    be optimising against a guess (#119).
